# References 
# 1. https://bioconductor.org/packages/release/bioc/vignettes/TCGAbiolinks/inst/doc/index.html
...
query_mutation <- GDCquery(project = 'TCGA-BRCA',
                           ...
                           access = 'open',
                           barcode = c('TCGA-LL-A73Y-01A-11D-A33E-09,
                                       TCGA-LL-A73Y-10B-01D-A33H-09',
                                       'TCGA-E9-A1NH-01A-11D-A14G-09,
                                       TCGA-E9-A1NH-11A-33D-A14G-09'))
